...
#define LOGD(...)  __android_log_print(ANDROID_LOG_DEBUG,"YSH",__VA_ARGS__) // 定义LOGD类型
...
JNIEXPORT jobject append(JNIEnv *env,jobject obj,jstring s){
	...
	jmethodID StringBuffer_append = env->GetMethodID(StringBufferCls,"append","(Ljava/lang/String;)Ljava/lang/StringBuffer;");
...
JNIEXPORT jstring toString(JNIEnv *env,jobject stringbuffer){
	jclass StringBufferCls = env->FindClass("java/lang/StringBuffer");
	jmethodID StringBuffer_toString = env->GetMethodID(StringBufferCls,"toString","()Ljava/lang/String;");
...
JNIEXPORT jobject deleteCharAt(JNIEnv *env,jobject obj,jint index){
	jclass StringBufferCls = env->FindClass("java/lang/StringBuffer");
	jmethodID StringBuffer_deleteCharAt = env->GetMethodID(StringBufferCls,"deleteCharAt","(I)Ljava/lang/StringBuffer;");
...
JNIEXPORT jstring getSessionToken(JNIEnv *env,jobject context){
	...
	jmethodID Session_getInstance = env->GetStaticMethodID(SessionCls,"getInstance","(Landroid/content/Context;)Lcom/subject/ysh/core/Session;");
	jmethodID Session_getSessionToken = env->GetMethodID(SessionCls,"getSessionToken","()Ljava/lang/String;");
...
JNIEXPORT jstring toLowerCase(JNIEnv *env,jstring jstr){
	...
	jmethodID String_toLowerCase = env->GetMethodID(StringCls,"toLowerCase","()Ljava/lang/String;");
...
JNIEXPORT jstring JNICALL Java_com_subject_ysh_core_HttpService_getSign
  (JNIEnv *env, jobject obj, jobject context, jobject pairs){

	jclass YshNameValuePairCls = env->FindClass("com/subject/ysh/core/YshNameValuePair");

    //转换为数组
	jclass ListCls = env->FindClass("java/util/List");
	jmethodID List_toArray = env->GetMethodID(ListCls,"toArray","([Ljava/lang/Object;)[Ljava/lang/Object;");
	...
	jmethodID YshNameValuePair_getName = env->GetMethodID(YshNameValuePairCls,"getName","()Ljava/lang/String;");
	jmethodID YshNameValuePair_getValue = env->GetMethodID(YshNameValuePairCls,"getValue","()Ljava/lang/String;");
