 ...
 */
public class AutoNumberProgressBar extends ViewGroup {
    ...
    public AutoNumberProgressBar(Context context) {
        this(context, null);
    }

    public AutoNumberProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AutoNumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
