...
import com.core.R;
import com.core.widget.recyclerview.animation.AlphaInAnimation;
import com.core.widget.recyclerview.animation.BaseAnimation;
import com.core.widget.recyclerview.animation.ScaleInAnimation;
import com.core.widget.recyclerview.animation.SlideInBottomAnimation;
import com.core.widget.recyclerview.animation.SlideInLeftAnimation;
import com.core.widget.recyclerview.animation.SlideInRightAnimation;
import com.core.widget.recyclerview.entity.IExpandable;
...
//        notifyItemRangeInserted(mData.size() - newData.size() + getHeaderLayoutCount(), newData.size());
    ...
    private K getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.ptr_pull_to_refresh_footer);
        }
